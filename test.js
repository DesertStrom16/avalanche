...
const testFunc = async () => {
  ...
  if (response && response.data) {
    // const firstRecord = getIndex(response.data, '"richItemRenderer', 2)
    // const lastRecord = getIndex(response.data, '"richItemRenderer', 3)
    ...
    console.log(JSON.parse(allRecordsString));
  }
};
